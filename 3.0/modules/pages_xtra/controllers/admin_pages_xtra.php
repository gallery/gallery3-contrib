...
// Change above line (from Pages module V3) to next line (from Pages module V2)  - if data does not save to database!
  ...
  private function get_new_page_form() {
    ...
    $pages_group->input("page_name")
                ->label(t("Name / URL extension &nbsp [No gaps between words. Only hyphen(-) or underscore(_) allowed]"));
    ...
    $pages_group->textarea("page_code")
                ->label(t("HTML Code &nbsp [Notes: 1. Page 'Body' only. &nbsp 2. Tags with 'style=' may not save correctly. Use CSS in your theme]"));
